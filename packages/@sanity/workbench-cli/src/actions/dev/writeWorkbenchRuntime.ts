...
// This file is auto-generated by the Sanity CLI
...
/**
 * Generates the `.sanity/workbench` directory with the workbench host's
 * static entry files — served as-is by the dev server, bundled into the build
 * output by `buildWorkbenchHost`.
 *
