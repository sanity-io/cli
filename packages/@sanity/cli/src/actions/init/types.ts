...
export interface InitOptions {
  ...
  fromCreate: boolean
  /** Whether the terminal session is interactive (has a TTY) */
  interactive: boolean
  mcp: boolean
 ...
 * @param isInteractive - Whether the terminal session is interactive (has a TTY)
 */
export function flagsToInitOptions(
  ...
  return {
    ...
    interactive: isInteractive ?? !isUnattended,
    mcp: flags.mcp,
