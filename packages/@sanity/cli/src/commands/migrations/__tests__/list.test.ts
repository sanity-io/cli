...
import {resolveMigrationScript} from '../../../actions/migration/resolveMigrationScript.js'
...
vi.mock('../../../actions/migration/resolveMigrationScript.js', async (importOriginal) => {
  const actual =
    await importOriginal<typeof import('../../../actions/migration/resolveMigrationScript.js')>()
  return {
    ...actual,
