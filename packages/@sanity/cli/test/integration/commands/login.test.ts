...
import {startServerForTokenCallback} from '../../../src/actions/auth/authServer.js'
import {LoginCommand} from '../../../src/commands/login.js'
import {AUTH_API_VERSION} from '../../../src/services/auth.js'
import {USERS_API_VERSION} from '../../../src/services/user.js'
import {canLaunchBrowser} from '../../../src/util/canLaunchBrowser.js'
...
vi.mock('../../../src/util/canLaunchBrowser.js', () => ({
...
vi.mock(import('../../../src/actions/auth/authServer.js'), async (importOriginal) => {
  const actual = await importOriginal()
  return {
    ...actual,
