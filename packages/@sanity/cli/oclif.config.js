export default {
  ...
  // Note: do not add '@sanity/migrate' or '@sanity/codegen' here. The
  // `migrations` and `typegen` commands now ship natively (see
  // commands/migrations/ and commands/typegen/); re-adding those plugins would
  // register duplicate command ids (and @sanity/codegen@8 no longer ships CLI).
  ...
  topics: {
    ...
    typegen: {description: 'Generate TypeScript types from GROQ queries'},
